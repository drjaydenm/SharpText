...
namespace Veldrid.TextRendering
{
    ...
    /// <summary>
    /// Taken from https://github.com/LayoutFarm/Typography/blob/master/PixelFarm.Typography/4_TextPrinter/GlyphPathBuilderBase.cs
    /// </summary>
    public abstract class GlyphPathBuilderBase
    {
        ...
        public GlyphPathBuilderBase(Typeface typeface)
        {
            ...
            {
                _cffEvalEngine = new CffEvaluationEngine();
            }
        }
